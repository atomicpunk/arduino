...
const unsigned int pattern_stream2[][10]={
  { 0x0ff,0x0df,0x09f,0x05f,0x01f,0x107,0x11f,0x15f,0x19f,0x1df },
  { 0x1df,0x0ff,0x0df,0x09f,0x05f,0x01f,0x107,0x11f,0x15f,0x19f },
  { 0x19f,0x1df,0x0ff,0x0df,0x09f,0x05f,0x01f,0x107,0x11f,0x15f },
  { 0x15f,0x19f,0x1df,0x0ff,0x0df,0x09f,0x05f,0x01f,0x107,0x11f },
  { 0x11f,0x15f,0x19f,0x1df,0x0ff,0x0df,0x09f,0x05f,0x01f,0x107 },
  { 0x107,0x11f,0x15f,0x19f,0x1df,0x0ff,0x0df,0x09f,0x05f,0x01f },
  { 0x01f,0x107,0x11f,0x15f,0x19f,0x1df,0x0ff,0x0df,0x09f,0x05f },
  { 0x05f,0x01f,0x107,0x11f,0x15f,0x19f,0x1df,0x0ff,0x0df,0x09f },
  { 0x09f,0x05f,0x01f,0x107,0x11f,0x15f,0x19f,0x1df,0x0ff,0x0df },
  { 0x0df,0x09f,0x05f,0x01f,0x107,0x11f,0x15f,0x19f,0x1df,0x0ff },
};
...
int main(int argc, char *argv[])
{
	...
	} else if(strcmp(argv[1], "stream2") == 0) {
		colorize(pattern_stream2, 10, color, numcolors, direction);
	}
	return 0;
}
